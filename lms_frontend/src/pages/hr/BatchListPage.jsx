// ==========================================================================
// ACADENO LMS — Batch List Page (US-HR-01)
// ==========================================================================
  ...
  return (
    <div className="hr-container">
      <div className="page-header">
        <div>
          ...
          <p style={{ color: 'var(--gray-text)', fontSize: 14 }}>
            Manage course batches and trainer assignments
          </p>
        </div>
        <button
      ...
      <div className="filter-bar">
        ...
        <button className="btn-sm btn-primary-sm" onClick={fetchBatches} style={{ alignSelf: 'flex-end' }}>
          Apply Filters
        </button>
      </div>
      ...
      <div className="hr-table-wrap">
        {loading ? (
          ...
          <div className="empty-state">No batches found. Create one to get started.</div>
        ) : (
            ...
            <tbody>
              {batches.map(b => (
                <tr key={b.id} onClick={() => navigate(`/batches/${b.id}`)}>
                  ...
                  <td>{b.trainer_name || <span style={{ color: '#ef4444' }}>Unassigned</span>}</td>
