...
const PERMISSIONS = {
  ...
  student: {
    ...
    allowedPrefixes: [
      '/api/student/courses', '/api/student/progress', '/api/student/tasks',
      '/api/student/invoices', '/api/student/dashboard', '/api/student/certificates',
      '/api/student/notifications', '/api/discussions'
    ],
  },
};
